              ...
              <div key={item.name} className="relative">
                {item.hasDropdown ? (
                  ...
                  <NavLink
                    to={item.path}
                    onClick={handleNavClick}
                    className={({ isActive }) => `px-4 py-2 rounded-lg font-semibold transition-all duration-200 ${
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-md shadow-xl border-t border-gray-100">
          <div className="px-4 py-6 space-y-3">
              ...
              <div key={item.name}>
                {item.hasDropdown ? (
                  ...
                  <NavLink
                    to={item.path}
                    onClick={handleNavClick}
                    className={({ isActive }) => `block w-full text-left px-4 py-3 rounded-lg font-semibold transition-colors ${
            ...
            <NavLink
              to="/charity"
              onClick={handleNavClick}
              className="block w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-gray-900 px-6 py-4 rounded-full font-bold transition-all duration-300 shadow-lg mt-4 text-center"
            >
              💝 Donate Now
            </NavLink>
          </div>
...
const DawahProgramPage = () => (
  <div className="min-h-screen pt-20">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-6">
          Da'wah <span className="bg-gradient-to-r from-green-600 to-yellow-500 bg-clip-text text-transparent">Programs</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          Comprehensive Islamic outreach and education programs designed to spread the beautiful message of Islam with wisdom and compassion.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <h3 className="text-2xl font-bold mb-4">Weekly Lectures</h3>
          <p className="text-gray-600 mb-4">
            Join our weekly community lectures featuring renowned Islamic scholars and local educators.
          </p>
          <ul className="text-sm text-gray-600 space-y-2">
            <li>• Every Friday after Maghrib</li>
            <li>• Topics cover Quran, Hadith, and contemporary issues</li>
            <li>• Q&A sessions with scholars</li>
            <li>• Free for all community members</li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-4">
            Engaging with the broader community through interfaith dialogue and cultural exchange.
          </p>
          <ul className="text-sm text-gray-600 space-y-2">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-4xl mb-4">💻</div>
          <h3 className="text-2xl font-bold mb-4">Digital Da'wah</h3>
          <p className="text-gray-600 mb-4">
            Spreading Islamic knowledge through modern digital platforms and social media.
          </p>
          <ul className="text-sm text-gray-600 space-y-2">
            <li>• Online lectures and webinars</li>
            <li>• Social media campaigns</li>
            <li>• Educational videos and podcasts</li>
            <li>• Digital Islamic resources</li>
          </ul>
        </div>
      </div>
    </div>
...
const EducationProgramPage = () => (
  <div className="min-h-screen pt-20">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-6">
          Educational <span className="bg-gradient-to-r from-green-600 to-yellow-500 bg-clip-text text-transparent">Initiatives</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          Providing comprehensive Islamic and secular education to strengthen both spiritual and academic growth.
        </p>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="bg-gradient-to-br from-green-50 to-yellow-50 rounded-3xl shadow-xl p-8">
          <h3 className="text-3xl font-bold text-gray-900 mb-6">Islamic Studies</h3>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <span className="text-green-600 text-xl">📚</span>
              <div>
                <h4 className="font-bold text-lg">Quran Memorization</h4>
                <p className="text-gray-600">Structured Hifz program for all ages with qualified teachers</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <span className="text-green-600 text-xl">🕌</span>
              <div>
                <h4 className="font-bold text-lg">Islamic Jurisprudence</h4>
                <p className="text-gray-600">Comprehensive Fiqh classes covering daily Islamic practices</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <span className="text-green-600 text-xl">🌙</span>
              <div>
                <h4 className="font-bold text-lg">Islamic History</h4>
                <p className="text-gray-600">Learn about Islamic civilization and great Muslim leaders</p>
              </div>
            </div>
          </div>
        </div>
        
        <div className="bg-gradient-to-br from-yellow-50 to-green-50 rounded-3xl shadow-xl p-8">
          <h3 className="text-3xl font-bold text-gray-900 mb-6">Academic Support</h3>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <span className="text-yellow-600 text-xl">🎓</span>
              <div>
                <h4 className="font-bold text-lg">Scholarship Programs</h4>
                <p className="text-gray-600">Financial assistance for deserving students in higher education</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <span className="text-yellow-600 text-xl">👨‍🏫</span>
              <div>
                <h4 className="font-bold text-lg">Tutoring Services</h4>
                <p className="text-gray-600">Free academic tutoring in mathematics, sciences, and languages</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <span className="text-yellow-600 text-xl">💻</span>
              <div>
                <h4 className="font-bold text-lg">Digital Literacy</h4>
                <p className="text-gray-600">Computer and internet skills training for all ages</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <Routes>
        ...
        <Route path="/programs/dawah" element={<DawahProgramPage />} />
        <Route path="/programs/education" element={<EducationProgramPage />} />
        <Route path="/programs/charity" element={<CharityPage />} />
        <Route path="/programs/cooperation" element={<CommunityPage />} />
