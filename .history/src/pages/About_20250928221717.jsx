            ...
            {focusAreas.map((area, index) => (
              ...
              >
                ...
                <div className="relative p-8 text-white">
                  ...
                  <div className="mt-6">
                    <button className="bg-blue-5 bg-opacity-20 hover:bg-opacity-30 backdrop-blur-sm border border-white border-opacity-30 text-white px-6 py-2 rounded-full font-semibold transition duration-300">
                      Learn More
                    </button>
                  </div>
                </div>
